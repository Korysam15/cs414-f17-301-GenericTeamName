...
public class BanqiGame {
	...
	private  void getAllPieces() {
		...
		//red pieces
		pieces[0]=new General(true,gameBoard.getSquaresOnBoard()[list.get(0)]);
		gameBoard.getSquaresOnBoard()[list.get(0)].setOn(pieces[0]);
		
		pieces[1]=new Advisor(true,gameBoard.getSquaresOnBoard()[list.get(1)]);
		gameBoard.getSquaresOnBoard()[list.get(1)].setOn(pieces[1]);
		pieces[2]=new Advisor(true,gameBoard.getSquaresOnBoard()[list.get(2)]);
		gameBoard.getSquaresOnBoard()[list.get(2)].setOn(pieces[2]);
		
		
		pieces[3]=new Elephant(true,gameBoard.getSquaresOnBoard()[list.get(3)]);
		gameBoard.getSquaresOnBoard()[list.get(3)].setOn(pieces[3]);
		pieces[4]=new Elephant(true,gameBoard.getSquaresOnBoard()[list.get(4)]);
		gameBoard.getSquaresOnBoard()[list.get(4)].setOn(pieces[4]);
		
		pieces[5]=new Chariot(true,gameBoard.getSquaresOnBoard()[list.get(5)]);
		gameBoard.getSquaresOnBoard()[list.get(5)].setOn(pieces[5]);
		pieces[6]=new Chariot(true,gameBoard.getSquaresOnBoard()[list.get(6)]);
		gameBoard.getSquaresOnBoard()[list.get(6)].setOn(pieces[6]);
		
		pieces[7]=new Cavalry(true,gameBoard.getSquaresOnBoard()[list.get(7)]);
		gameBoard.getSquaresOnBoard()[list.get(7)].setOn(pieces[7]);
		pieces[8]=new Cavalry(true,gameBoard.getSquaresOnBoard()[list.get(8)]);
		gameBoard.getSquaresOnBoard()[list.get(8)].setOn(pieces[8]);
		
		pieces[9]=new Cannon(true,gameBoard.getSquaresOnBoard()[list.get(9)]);
		gameBoard.getSquaresOnBoard()[list.get(9)].setOn(pieces[9]);
		pieces[10]=new Cannon(true,gameBoard.getSquaresOnBoard()[list.get(10)]);
		gameBoard.getSquaresOnBoard()[list.get(10)].setOn(pieces[10]);
		
		pieces[11]=new Soldier(true,gameBoard.getSquaresOnBoard()[list.get(11)]);
		gameBoard.getSquaresOnBoard()[list.get(11)].setOn(pieces[11]);
		pieces[12]=new Soldier(true,gameBoard.getSquaresOnBoard()[list.get(12)]);
		gameBoard.getSquaresOnBoard()[list.get(12)].setOn(pieces[12]);
		pieces[13]=new Soldier(true,gameBoard.getSquaresOnBoard()[list.get(13)]);
		gameBoard.getSquaresOnBoard()[list.get(13)].setOn(pieces[13]);
		pieces[14]=new Soldier(true,gameBoard.getSquaresOnBoard()[list.get(14)]);
		gameBoard.getSquaresOnBoard()[list.get(14)].setOn(pieces[14]);
		pieces[15]=new Soldier(true,gameBoard.getSquaresOnBoard()[list.get(15)]);
		gameBoard.getSquaresOnBoard()[list.get(15)].setOn(pieces[15]);
		
		
		//black pieces
		pieces[16]=new General(false,gameBoard.getSquaresOnBoard()[list.get(16)]);
		gameBoard.getSquaresOnBoard()[list.get(16)].setOn(pieces[16]);
		
		pieces[17]=new Advisor(false,gameBoard.getSquaresOnBoard()[list.get(17)]);
		gameBoard.getSquaresOnBoard()[list.get(17)].setOn(pieces[17]);
		pieces[18]=new Advisor(false,gameBoard.getSquaresOnBoard()[list.get(18)]);
		gameBoard.getSquaresOnBoard()[list.get(18)].setOn(pieces[18]);
		
		pieces[19]=new Elephant(false,gameBoard.getSquaresOnBoard()[list.get(19)]);
		gameBoard.getSquaresOnBoard()[list.get(19)].setOn(pieces[19]);
		pieces[20]=new Elephant(false,gameBoard.getSquaresOnBoard()[list.get(20)]);
		gameBoard.getSquaresOnBoard()[list.get(20)].setOn(pieces[20]);
		
		pieces[21]=new Chariot(false,gameBoard.getSquaresOnBoard()[list.get(21)]);
		gameBoard.getSquaresOnBoard()[list.get(21)].setOn(pieces[21]);
		pieces[22]=new Chariot(false,gameBoard.getSquaresOnBoard()[list.get(22)]);
		gameBoard.getSquaresOnBoard()[list.get(22)].setOn(pieces[22]);
		
		pieces[23]=new Cavalry(false,gameBoard.getSquaresOnBoard()[list.get(23)]);
		gameBoard.getSquaresOnBoard()[list.get(23)].setOn(pieces[23]);
		pieces[24]=new Cavalry(false,gameBoard.getSquaresOnBoard()[list.get(24)]);
		gameBoard.getSquaresOnBoard()[list.get(24)].setOn(pieces[24]);
		
		pieces[25]=new Cannon(false,gameBoard.getSquaresOnBoard()[list.get(25)]);
		gameBoard.getSquaresOnBoard()[list.get(25)].setOn(pieces[25]);
		pieces[26]=new Cannon(false,gameBoard.getSquaresOnBoard()[list.get(26)]);
		gameBoard.getSquaresOnBoard()[list.get(26)].setOn(pieces[26]);
		
		pieces[27]=new Soldier(false,gameBoard.getSquaresOnBoard()[list.get(27)]);
		gameBoard.getSquaresOnBoard()[list.get(27)].setOn(pieces[27]);
		pieces[28]=new Soldier(false,gameBoard.getSquaresOnBoard()[list.get(28)]);
		gameBoard.getSquaresOnBoard()[list.get(28)].setOn(pieces[28]);
		pieces[29]=new Soldier(false,gameBoard.getSquaresOnBoard()[list.get(29)]);
		gameBoard.getSquaresOnBoard()[list.get(29)].setOn(pieces[29]);
		pieces[30]=new Soldier(false,gameBoard.getSquaresOnBoard()[list.get(30)]);
		gameBoard.getSquaresOnBoard()[list.get(30)].setOn(pieces[30]);
		pieces[31]=new Soldier(false,gameBoard.getSquaresOnBoard()[list.get(31)]);
	...
	public boolean isvalidMove(Square from, Square to){
		...
		if((to.isEmpty()  ||  (from.getOn().rank>= to.getOn().rank && from.getOn().color!=to.getOn().color))){
			
			if((from.getY()==to.getY() && Math.abs(from.getX()-to.getX())==1)  ||  (from.getX()==to.getX() && Math.abs(from.getY()-to.getY())==1)){
